...
Contributions are welcome, and they are greatly appreciated! Every little bit helps, and credit will always be given. The following guidelines use the pyfar base package but also hold for other packages from the pyfar ecosystem. for this, exchange the word *pyfar* in commands by the name of the package, e.g., *sofar*.
...
2. Clone your fork locally and cd into the pyfar directory::
    ...
    $ git clone --recursive https://github.com/pyfar/pyfar.git
    $ cd pyfar
...
Some pyfar packages contain submodules. If changes inside the submodule should be included in a pyfar package, they have to be updated

$ git submodule update --init --recursive
$ git submodule update --recursive --remote

To take effect, the changes have to be committed afterwards
